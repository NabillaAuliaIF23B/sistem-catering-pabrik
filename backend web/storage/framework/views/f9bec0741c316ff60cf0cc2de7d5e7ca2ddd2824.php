...
<body>
    ...
    <main class="main-content">
        ...
        <div class="row">
          <div class="col-auto">
            <a href="<?php echo e(route('user.create')); ?>" class="btn btn-outline-primary btn-sm d-inline-flex align-items-center">
              <i class="bi bi-plus me-1"></i> Buat Akun Baru
            </a>
          </div>
        </div>
...
</html><?php /**PATH /home/kelompo7/catering.kelompok47.my.id/resources/views/hrga/user.blade.php ENDPATH**/ ?>