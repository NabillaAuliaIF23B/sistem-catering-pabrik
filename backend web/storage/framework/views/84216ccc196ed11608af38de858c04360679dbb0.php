...
<body>
    ...
    <main class="main-content">
        <div class="dashboard">
            <h3><i class="ri-user-3-line icon"></i> PROFILE Karyawan</h3><hr>
            ...
            <div class="mt-3">
                <a href="<?php echo e(route('password.change')); ?>" class="btn btn-primer">
...
</html><?php /**PATH /home/kelompo7/catering.kelompok47.my.id/resources/views/karyawan/dashboard.blade.php ENDPATH**/ ?>