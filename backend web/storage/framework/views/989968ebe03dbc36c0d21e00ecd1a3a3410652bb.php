...
<body>
    ...
    <main class="main-content">
        <div class="dashboard">
            <h3><i class="ri-user-3-line icon"></i> PROFILE hrga</h3><hr>
            ...
            <div class="mt-3">
                <a href="<?php echo e(route('password.change')); ?>" class="btn btn-primary">
...
<?php /**PATH /home/kelompo7/catering.kelompok47.my.id/resources/views/hrga/profile.blade.php ENDPATH**/ ?>